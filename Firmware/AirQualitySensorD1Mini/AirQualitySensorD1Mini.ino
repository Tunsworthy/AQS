...
uint32_t   g_am2320_te_value     = 0; //Temp
uint32_t   g_am2320_hu_value     = 0; //humity
...
void reportToMqtt()
{
  ...
  if (true == g_pms_ppd_readings_taken)
  {
    sprintf(g_mqtt_message_buffer,"{\"PMS5003\":{\"CF1\":%i,\"CF2.5\":%i,\"CF10\":%i,\"PM1\":%i,\"PM2.5\":%i,\"PM10\":%i,\"PB0.3\":%i,\"PB0.5\":%i,\"PB1\":%i,\"PB2.5\":%i,\"PB5\":%i,\"PB10\":%i,\"UKAQI\":%i},\"AM2320\":{\"Temperature\":%i,\"Humidity\":%i}}",
    ...
    sprintf(g_mqtt_message_buffer,  "{\"PMS5003\":{\"CF1\":%i,\"CF2.5\":%i,\"CF10\":%i,\"PM1\":%i,\"PM2.5\":%i,\"PM10\":%i},\"AM2320\":{\"Temperature\":%i,\"Humidity\":%i}}",
